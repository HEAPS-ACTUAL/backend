...
async function getUserByEmail(req, res = null) {
    ...
    userFound = await executeQuery(sqlQuery, [inputEmail]);
...
async function createNewUser(req, res) {
    ...
    try {
        ...
        const insertOk = await executeQuery(sqlQuery, [inputEmail, hashedPassword, inputFirstName, inputLastName, inputGender,]);
...
async function deleteUser(req, res) {
    ...
    try {
        ...
        const deleteResult = await executeQuery(sqlQuery, [inputEmail]);
    ...
    */
    ...
    if(inputFirstName !== null && inputLastName !== null){ // NAME CHANGE
        try {
            ...
            const updateResult = await executeQuery(sqlQuery, [inputFirstName, inputLastName, inputEmail,]);
        ...
        if(await bothPasswordsMatch(inputPassword, hashedPassword) === false){
            ...
            try {
                ...
                const updateResult = await executeQuery(sqlQuery, [newHashedPassword, inputEmail,]);
