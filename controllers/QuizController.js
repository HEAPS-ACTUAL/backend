...
async function createNewQuiz(testID, difficulty){
    try {
        ...
        const insertOk = await executeQuery(sqlQuery, [testID, difficulty]);
...
async function storeUserQuizAnswers(req, res){
    ...
    try{
        ...
        const insertOk = await executeQuery(sqlQuery, [testID, formattedUserAnswers]);
...
async function reviewQuiz(req, res){
    ...
    try{
        ...
        const returnedData = await executeQuery(sqlQuery, [testID, attemptNo]); // Go to 'test_format_examples/reviewQuiz.js' to see how returnedData looks like
